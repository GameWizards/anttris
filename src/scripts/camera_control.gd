...
var zoom_rate = 0.5            # the rate at which the camera zooms in and out of the target
var orbitrate = 0.01         # the rate the camera orbits the target when the mouse is moved
